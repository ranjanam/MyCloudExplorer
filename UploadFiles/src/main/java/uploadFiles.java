...
class uploadThreads extends Thread
{
    ...
    uploadThreads(JSONObject required_service_params,Channel sendChannel,String reply_to_server_queue)
    {
...
public class uploadFiles {
    ...
    private final static String recv_req_queue = "upload_queue";
...
//                System.out.println(" [x] Received '" + message.toString() + "'");
                ...
                try {
                    ...
                    uploadThreads object = new uploadThreads(jsonobj,sendChannel,reply_to_server_queue);
                    object.start();
                }
                catch(Exception e)
                {
