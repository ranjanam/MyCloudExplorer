...
class listThreads extends Thread
{
    ...
    listThreads(JSONObject required_service_params,Channel sendChannel,String reply_to_server_queue)
    {
...
public class listFiles {
    ...
    private final static String recv_req_queue = "list_queue";
...
//                System.out.println(" [x] Received '" + message.toString() + "'");
                ...
                try {
                    ...
                    listThreads object = new listThreads(jsonobj,sendChannel,reply_to_server_queue);
                    object.start();
                }
                catch(Exception e)
                {
