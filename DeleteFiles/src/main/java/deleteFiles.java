...
class deleteThreads extends Thread
{
    JSONObject required_service_params;
    public Channel sendChannel;
    public String reply_to_server_queue;
    deleteThreads(JSONObject required_service_params,Channel sendChannel,String reply_to_server_queue)
    {
...
public class deleteFiles {
    ...
    private final static String recv_req_queue = "delete_queue";
...
//                System.out.println(" [x] Received '" + message.toString() + "'");
                ...
                try {
                    ...
                    deleteThreads object = new deleteThreads(jsonobj,sendChannel,reply_to_server_queue);
                    object.start();
                }
                catch(Exception e)
                {
